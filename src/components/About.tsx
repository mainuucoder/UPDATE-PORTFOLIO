    ...
    >
      <div className="container mx-auto px-6">
        ...
        <div 
          ...
          className="mt-16 p-6 rounded-xl shadow-sm border border-border bg-gradient-to-br from-card via-background to-muted/50 dark:from-card dark:via-background dark:to-muted/30"
        >
        ...
        {/* Journey Forward */}
        <div className={`mt-12 text-center transition-all duration-800 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8"}`}>
